...
public enum ExceptionType {
    ...
    VCE10007(-10007L, ExceptionTypeCategory.VALIDATE_CLIENT_EXCEPTION, ExceptionType.SubSystem.SUB_SYSTEM_BASEINFO, "基础资料客户端验证异常"),
    VCE10027(-10027L, ExceptionTypeCategory.VALIDATE_CLIENT_EXCEPTION, ExceptionType.SubSystem.SUB_SYSTEM_MANAGE, "后台管理系统客户端验证异常"),
    VCE10030(-10030L, ExceptionTypeCategory.VALIDATE_CLIENT_EXCEPTION, SubSystem.SUB_SYSTEM_CACHE, "缓存系统客户端验证异常"),

    VBE20007(-20007L, ExceptionTypeCategory.VALIDATE_BUSINESS_EXCEPTION, ExceptionType.SubSystem.SUB_SYSTEM_BASEINFO, "基础资料业务验证异常"),
    ...
    BE40144(-40144L, ExceptionTypeCategory.BUSINESS_EXCEPTION, ExceptionType.SubSystem.SUB_SYSTEM_BASEINFO, "探测系统时发现系统停止！"),
