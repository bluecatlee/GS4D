...
import com.github.bluecatlee.gs4d.cache.model.CacheKeyGenerateRule;
...
import com.github.bluecatlee.gs4d.cache.service.CacheStoreService;
    ...
    private static String getCacheResultFromCache(String methodName, AbstractRequest paramsRequest) {
        ...
        for(int i = 0; i < length; ++i) {
            ...
            try {
                ...
                throw new ValidateBusinessException(Constants.SUB_SYSTEM, ExceptionType.VBE20030, "方法:" + methodName + ",生成缓存的主键所需栏位:" + cacheCol + ",类:" + paramsRequest.getClass().getName() + "无此属性!");
            }

            if (obj == null) {
                throw new ValidateBusinessException(Constants.SUB_SYSTEM, ExceptionType.VBE20030, "方法:" + methodName + ",生成缓存的主键所需栏位:" + cacheCol + "对象的值为null！");
            }
    ...
    private static CacheKeyGenerateRule getCacheKeyGenerateRule(final Long dataSign, final String methodName) {
        try {
            ...
            if (CacheUtil.CacheUtilInnerClass.cacheStoreService == null) {
                throw new ValidateBusinessException(Constants.SUB_SYSTEM, ExceptionType.VBE20030, "缓存初始化还未完成,请稍等...");
            } else {
            ...
            throw new ValidateBusinessException(Constants.SUB_SYSTEM, ExceptionType.VBE20030, "未找方法:" + methodName + "缓存的主键生成规则");
        }
    }
